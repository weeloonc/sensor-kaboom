...
/** Parses the accelerometer sensor log file. */
public class AcclSensorLogParser
    extends SensorLogParser {

    /** Constructor that initialises the parsing. */
    public AcclSensorLogParser( File logFile ) 
        throws IOException {
        super( logFile );
    }
    ...
    protected void parseNextLine() 
        ...
        nextEvent = new AcclEvent( timestamp , x , y , z , accuracy );
    }
}
