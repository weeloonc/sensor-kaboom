...
/** Parses the gravity sensor log file. */
public class GravitySensorLogParser
    extends SensorLogParser {

    /** Constructor that initialises the parsing. */
    public GravitySensorLogParser( File logFile ) 
        throws IOException {
        super( logFile );
    }
    ...
    protected void parseNextLine() 
        ...
        nextEvent = new GravityEvent( timestamp , x , y , z , accuracy );
    }
}
