...
/** Parses the magnetic sensor log file. */
public class MagneticSensorLogParser
    extends SensorLogParser {

    /** Constructor that initialises the parsing. */
    public MagneticSensorLogParser( File logFile ) 
        throws IOException {
        super( logFile );
    }
    ...
    protected void parseNextLine() 
        ...
        nextEvent = new MagneticEvent( timestamp , x , y , z , accuracy );
    }
}
